            ...
            <form method="post" action="/dashboard/posts/{{ $post->slug }}" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title"
                        autofocus value="{{ old('title', $post->title) }}" autocomplete="off">
                    @error('title')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('source') is-invalid @enderror" id="source" name="source"
                        value="{{ old('source', $post->source) }}" autocomplete="off">
                    @error('source')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3">
                    ...
                    @enderror
                    <input value="{{ old('body', $post->body) }}" type="hidden" id="body" name="body" autocomplete="off">
                    <trix-editor input="body"></trix-editor>
                </div>

                <button type="submit" class="btn btn-sm btn-primary"> <i class="fas fa-plus-square"></i> Update
                    Posts</button>
            </form>
        </div>
    </div>
